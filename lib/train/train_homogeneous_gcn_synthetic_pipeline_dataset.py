...
def train_homogeneous_gcn(
    ...
    train_dataset = SyntheticPipelineDataset(
        root=dataset_root,
        split="train",
    ...
    val_dataset = SyntheticPipelineDataset(
        root=dataset_root,
        split="val",
        direction=edge_direction,
        dataset_len=5000,
    ...
    test_dataset = SyntheticPipelineDataset(
        root=dataset_root,
        split="test",
        direction=edge_direction,
        dataset_len=5000,
...
if __name__ == "__main__":
    train_homogeneous_gcn(
        dataset_root=r"C:\Users\Konstantin\PycharmProjects\NIR\dataset\synthetic_pipeline_dataset",
        logdir=r"C:\Users\Konstantin\PycharmProjects\NIR\experiments\homogeneous_gcn\synthetic_pipeline_dataset",
